...
function resize() {
    ...
    player.screenWidth = c.width = global.screenWidth = (global.playerType == 'player' ? window.innerWidth : global.gameWidth) - 0;
    player.screenHeight = c.height = global.screenHeight = (global.playerType == 'player' ? window.innerHeight : global.gameHeight) - 0;
